...
const Planning = () => {
    ...
    return (
        <div className="flex h-screen w-screen bg-gray-50">
            ...
            <main className="flex-1 p-8 bg-white shadow-md overflow-y-auto w-full">
                ...
                <div className="mb-4 flex space-x-4">
                    ...
                    {/* Duration Input (Min 15 Minutes, Default 15, Step 15) */}
                    <div className="w-1/3">
                ...
                <div className="mb-4">
                    ...
                    <TimezoneSelect value={timezone} onChange={setTimezone} className="w-full"/>
                </div>

                {/* Submit Button */}
                <button onClick={handleSubmit} className="bg-blue-500 text-white px-6 py-2 rounded w-full mt-4">
                    Submit Planning
                </button>
            </main>
        </div>
